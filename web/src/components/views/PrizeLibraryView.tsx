...
import { Search, BookOpen, Trash2, X, Loader2 } from 'lucide-react';
...
export function PrizeLibraryView({ branch: _branch, prizes, isLoading, onDeletePrize }: PrizeLibraryViewProps) {
